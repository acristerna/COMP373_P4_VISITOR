...
public class MacMailClientVisitor implements MailClientVisitor{
    ...
    public void visit(OutlookMailClient mailClient) {
      System.out.println("Configuration of Outlook mail client for Mac complete");
    }
    @Override
    public void visit(GmailMailClient mailClient) {
        System.out.println("Configuration of Gmail mail client for Mac complete");
    }
    @Override
    public void visit(ThunderbirdMailClient mailClient) {
        System.out.println("Configuration of Thunderbird mail client for Mac complete");
    }
}